...
`flake8_sphinx_links` uses `tox` to automate testing, autoformatting and packaging.

For more information on installing `tox` see https://tox.readthedocs.io/en/latest/install.html

## Coding style

`flake8_sphinx_links` uses `yapf` for code formatting and `isort` to sort imports.
