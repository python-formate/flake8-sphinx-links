...
and can be accessed from the following URL: https://github.com/domdfcoding/flake8_sphinx_links"

If you have ``git`` installed, you can clone the repository with the following command:

.. code-block:: bash

    $ git clone https://github.com/domdfcoding/flake8_sphinx_links"
    > Cloning into 'flake8_sphinx_links'...
